...
test("los botones de arrepentimiento y baja de servicio están visibles en la home", async ({ page }) => {
  await page.goto("/");
  await expect(page.getByRole("link", { name: /Botón de arrepentimiento/ }).first()).toBeVisible();
